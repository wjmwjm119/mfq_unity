...
//			half fresnel = 1.0f - saturate(dot(i.viewDir, i.normal));
			...
			fixed4 cubeColor = 0;
			cubeColor.rgb = DecodeHDR_NoLinearSupportInSM2(refl, unity_SpecCube0_HDR).xyz;

//			cubeColor.rgb = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, worldRefl,0);
...
//			final.rgb = _WorldSpaceLightPos0;
     		final.a=1;	
